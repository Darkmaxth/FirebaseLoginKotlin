package firebase.app.firebaseloginkotlin
...
import firebase.app.firebaseloginkotlin.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Es para la interfaz ya ingresada .. donde updateProfileAppCompatButton es el boton de guardar nombre
        // esto hara que se actualice el nombre guardado en nameEditText
        ...
        // Esto es para actualizar la imagen de usuario
        //binding.profileImageView.setOnClickListener {
           // fileManager()
       // }
        // es el boton eliminarcuenta visto en la pantalla, al hacer click abre la funcion DeleteAccountActivity
